...
- Ability to update VM Network QoS when QoS modified on a vNIC profile.
- None as default keymap for VNC keyboard layout due to keymap detection being built into noVNC since 1.0.
